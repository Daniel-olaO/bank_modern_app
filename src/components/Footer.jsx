        ...
        mb-8 w-full`}>
            ...
            md:mt-0 mt-10'>
                {footerLinks.map((footerLink) =>(
                    <div key={footerLink.ke} className='flex
                    flex-col ss:my-4 min-w-[150px]'>
                        <h4 className='font-poppins font-meduim
                        ...
                        <ul className='list-none mt-4'>
                            {footerLink.links.map((link, index) =>(
                                ...
                                font-normal text-0[16px] leading-[24px]
                                text-dimWhite hover:ttext-secondary cursor-pointer
