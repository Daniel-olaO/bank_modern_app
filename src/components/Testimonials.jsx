    ...
    ${styles.flexCenter} flex-col relative`}>
        ...
        relative z-[1]'>
            ...
            <div className='w-full md:mt-0 mt-6'>
                ...
                max-w-[450px]`}>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusantium ea unde itaque quas iste reiciendis sit, obcaecati ab quidem molestiae, soluta facilis magni, 
                </p>
            </div>
        </div>
